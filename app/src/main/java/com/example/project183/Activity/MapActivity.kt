...
class MapActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        searchPlaceView = findViewById<SearchPlaceBottomSheetView>(R.id.search_place_view).apply {
            ...
            addOnNavigateClickListener { searchPlace ->
                returnSelectedAddress(searchPlace)
            }
    ...
    private fun returnSelectedAddress(searchPlace: SearchPlace) {
        val address = searchPlace.address?.formattedAddress(SearchAddress.FormatStyle.Full)
